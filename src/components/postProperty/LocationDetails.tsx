...
export default function LocationDetails({ form, setForm }: any) {
...
className="h-14 text-lg pr-40"
/>

<button
onClick={handlePickLocation}
className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-2 text-blue-600 font-medium"
>
<MapPin size={18}/>
Pick my location
</button>
