...
export default function BuilderDashboard() {
    ...
    return (
      <div className="min-h-screen bg-[#0f172a] flex items-center justify-center">
        <div className="text-center max-w-md mx-auto px-4">
          ...
          <h2 className="text-2xl font-bold text-white mb-3">Builder Panel</h2>
          <p className="text-slate-400 mb-6">
            This is the Builder Panel. As a regular user, please use the
    ...
    return (
      <div className="min-h-screen bg-[#0f172a] flex items-center justify-center">
        <div className="text-center max-w-md mx-auto px-4">
          ...
          <h2 className="text-2xl font-bold text-white mb-3">Builder Panel</h2>
          <p className="text-slate-400 mb-6">
            This is the Builder Panel. As a registered Dealer, please use the
  ...
  if (userRole === "builder" && userApproved === false) {
    return (
      <div className="min-h-screen bg-[#0f172a] flex items-center justify-center">
        <div className="text-center max-w-md mx-auto px-4">
          ...
          <p className="text-slate-400 mb-6">
            ...
            details and activate your builder panel within 24-48 hours.
          </p>
